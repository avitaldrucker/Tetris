...
export default class View {
  ...
  drawRestartGame() {
    ...
    gameOverContainer.className = "visible";
      ...
      if (!this.played) {
        gameOverContainer.appendChild(this.createPlayAgainButton("Start"));
      }
      else if (!this.replay) {
        const startButton = document.getElementById("button");
        gameOverContainer.removeChild(startButton);
        gameOverContainer.appendChild(this.createGameOverHeader());
        gameOverContainer.appendChild(this.createPlayAgainButton("Play again"));
        this.replay = true;
      }
  ...
  createPlayAgainButton(buttonText) {
